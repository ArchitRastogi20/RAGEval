...
This pipeline is designed to generate Question-Reference-Answer (QRA) triples based on configuration files and documents. It supports multiple domains and languages (en, zh, it), providing scripts for specific domain handling.
...
- **`LANGUAGES`**: The languages for QRA generation (default: `zh, en, it`)
...
- **`LANGUAGES`**: The languages for reference refinement (default: `zh, en, it`)
- **`MODEL_NAME`**: The OpenAI model name to use (default: `gpt-4o`)
